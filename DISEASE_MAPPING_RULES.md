...
Special cases must be explicitly reported.
...
|--------|--------|
| ICD-10 Code | E78.1 |
| ICD-10 Disease | Hypertriglyceridemia |
| Can Match | Yes |
...
|--------|--------|
| ICD-10 Code | I63 |
| ICD-10 Disease | Ischemic stroke |
| Can Match | No |
| Internal Disease | Unmapped |
| Status | Unmapped |
